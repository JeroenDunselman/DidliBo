...
//        arpeggioSynthesizer.stop(noteNumber: noteNumber, channel: 0)
  self.stop(noteNumber: noteNumber)
    }
    func play(noteNumber: MIDINoteNumber) {
//        arpeggioSynthesizer.play(noteNumber: noteNumber, velocity: 80, channel: 0)
    self.play(noteNumber: noteNumber)
    }
